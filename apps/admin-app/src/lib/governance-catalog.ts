...
export const governanceRoles = [
  ...
  role("customs_broker", "Agent commissionnaire", "customs", "customs_operations", "agent"),
  role("customs_broker_manager", "Responsable commissionnaire", "customs", "customs_operations", "manager"),
  role("finance_customs_agent", "Agent finance douanière", "customs", "customs_operations", "specialist"),
