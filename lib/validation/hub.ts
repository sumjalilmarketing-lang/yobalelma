...
export const hubBatchSchema = z.object({
  ...
  destinationCountry: z.string().trim().min(2, "Pays destination requis.").max(80).optional().or(z.literal("")),
  destinationCity: z.string().trim().min(2, "Ville destination requise.").max(80).optional().or(z.literal("")),
