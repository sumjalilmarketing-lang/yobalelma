...
export const platformRoles = [
  ...
  "compliance_agent",
  "customs_broker",
  "customs_broker_manager",
  "finance_customs_agent",
  "finance_manager",
  "support_agent",
  "finance_agent",
  "accounting_agent",
...
export const roleDashboardPath: Record<PlatformRole, string> = {
  ...
  customs_broker: "/command/douane",
  customs_broker_manager: "/command/douane",
  finance_customs_agent: "/command/douane/droits-taxes",
...
export const rolePermissions: Record<PlatformRole, PlatformPermission[]> = {
  ...
  customs_broker: ["shipment:read", "shipment:track", "operations:read"],
  customs_broker_manager: ["shipment:read", "shipment:track", "operations:read", "operations:write", "admin:read"],
  finance_customs_agent: ["shipment:read", "shipment:track", "finance:read", "operations:read", "admin:read"],
