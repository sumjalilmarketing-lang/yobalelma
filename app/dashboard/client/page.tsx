    ...
    >
      {state.status === "ready" ? (
        <RoleDashboard
          ...
          actions={[
            { href: "/dashboard/client/international", label: "Parcours international" },
          ...
          checkpoints={[
            "Profil client actif et protege.",
  ...
  return (
    <div className="rounded-lg border border-amber-200 bg-amber-50 p-6">
      ...
      <p className="mt-3 max-w-2xl leading-7 text-black/60">
        Cet espace est momentanément indisponible. Réessaie dans quelques instants.
      </p>
    </div>
  );
}
